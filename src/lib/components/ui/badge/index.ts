...
export const badgeVariants = tv({
	...
	variants: {
		variant: {
			...
			green:
				"bg-green-200 hover:bg-green-200/80 border-transparent",
			yellow:
				"bg-yellow-200 hover:bg-destructive/80 border-transparent",
			red: 
				"bg-red-400 hover:bg-destructive/80 border-transparent",
		},
	},
	defaultVariants: {
		variant: "default",
